...
`;
		...
		*/
		...
		function SessionManager({ useSessions, useWorkspaces, api, sessions, workspaceActions, close }) {
			...
			const renderWorkspaceLabel = (group, index) => {
				...
				return (0, react.createElement)("div", {
					...
					children: [
						...
						draggable ? (0, react.createElement)("span", { className: "dsh-delete-session__group-actions" }, (0, react.createElement)("button", {
						...
						}, strings.workspaceToTop), (0, react.createElement)("button", {
							className: "dsh-delete-session__group-action",
							type: "button",
						...
						}, strings.workspaceRename), (0, react.createElement)("button", {
			...
			const handleBatchDelete = (0, react.useCallback)(async () => {
				...
				if (failCount === 0) showNotice({
					...
					showNotice({
						kind: "error",
						text: strings.batchFailed.replace("{msg}", `${okCount}/${ids.length} 成功，失败 ${failCount} 个（${detail}）`)
					});
				}
				sessions.refresh?.();
			}, [
			...
			return (0, react.createElement)("div", { "data-dsh-delete-session": "" }, (0, react.createElement)("div", { className: "dsh-delete-session__header" }, (0, react.createElement)("span", { className: "dsh-delete-session__title" }, strings.title), (0, react.createElement)("button", {
				type: "button",
				...
				type: "checkbox",
				checked: activeRows.some((session) => !session.running && session.id !== list.current) && activeRows.every((session) => session.running || session.id === list.current || selectedIds.has(session.id)),
		...
		function apply(ctx) {
			...
			// conversation.session.header.utilities registration removed - delete button hidden
			// Session management is still available in settings
		}
		...
		*/
		function CompactionThresholdRow(_props) {
			...
			}), (0, react.createElement)("span", { className: "dsh-delete-session__general-percent" }, "%"), (0, react.createElement)("button", {
				className: "dsh-delete-session__general-save",
				type: "button",
				disabled: saveState === "saving",
				onClick: save
			}, saveState === "saved" ? strings.compactionSaved : strings.compactionSave))), (0, react.createElement)("div", { className: "dsh-delete-session__general-slider-wrap" }, (0, react.createElement)("input", {
		...
		function SessionDrawer({ api, sessions }) {
			...
			const renderWorkspaceLabel = (group, index) => {
				...
				return (0, react.createElement)("div", {
					...
					children: [(0, react.createElement)("span", { className: "dsh-delete-session__group-label-text" }, `${group.title} (${group.rows.length})`), draggable ? (0, react.createElement)("span", { className: "dsh-delete-session__group-actions" }, (0, react.createElement)("button", {
						className: "dsh-delete-session__group-action",
						type: "button",
						title: strings.workspaceToTop,
						onPointerDown: (e) => e.stopPropagation(),
